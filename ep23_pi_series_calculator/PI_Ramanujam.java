...
public class PI_Ramanujam extends PISeries {
    ...
    public PI_Ramanujam() {
        ...
        BigDecimal sqrtOf2=  new BigDecimal("1.4142135623730950488016887242096980785696718753769480731766797379907324784621070388503875343276415727");
        BigDecimal coeff1 = new BigDecimal(2);
        BigDecimal coeff2 = new BigDecimal(9801);
    ...
    public void calculatePI() {
        ...
        // (4n)! / n!^4
        BigDecimal firstNumerator = new BigDecimal( getFactorial( FOUR.multiply(n) ) );
        BigInteger nFactorial = getFactorial(n);
        BigDecimal firstDenominator = new BigDecimal( nFactorial.pow(4) );
        BigDecimal result1 = firstNumerator.divide(firstDenominator, PRECISION);

        //Variable result2 should contain result of
        // (26390n + 1103) / (396 ^ (4*n))
        BigDecimal secondNumerator = new BigDecimal(MULTIPLICAND_1.multiply(n));
        secondNumerator = secondNumerator.add(MULTIPLICAND_2);
        int pow = n.multiply(FOUR).intValue();
        BigDecimal secondDenominator = new BigDecimal(MULTIPLICAND_3.pow(pow));
